    ...
    >
      ...
      <div className="w-full px-4 sm:px-6 lg:px-16 xl:px-24 relative z-10 py-14 sm:py-20 md:py-28">
        <div className="max-w-2xl md:max-w-none">
          {/* Main title */}
          <h1 ref={titleRef} className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white leading-tight mb-6 tracking-tight max-md:text-balance md:whitespace-nowrap">
            {t('hero.title')}
          </h1>

          {/* Subtitle */}
          <p ref={subtitleRef} className="text-base sm:text-lg text-white leading-relaxed mb-10 max-w-xl md:max-w-2xl">
            {t('hero.subtitle')}
          </p>
